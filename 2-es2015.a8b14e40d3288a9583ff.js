...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormulaOneApiService", function() { return FormulaOneApiService; });
...
let FormulaOneApiService = /*@__PURE__*/ (() => {
    class FormulaOneApiService {
        constructor(http) {
            this.http = http;
        }
        setHeaders() {
        ...
        get(path, params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpParams"]()) {
            return this.http
                .get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiFormulaOne.url}${path}`, { headers: this.setHeaders(), params: params })
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((res) => res.results), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])((error) => this.formatErrors(error)));
        }
    }
    FormulaOneApiService.ɵfac = function FormulaOneApiService_Factory(t) { return new (t || FormulaOneApiService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"])); };
    FormulaOneApiService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: FormulaOneApiService, factory: FormulaOneApiService.ɵfac, providedIn: 'root' });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormulaOneComponent", function() { return FormulaOneComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _shared_services_formula_one_formula_one_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../shared/services/formula-one/formula-one.service */ "./src/app/shared/services/formula-one/formula-one.service.ts");
...
function FormulaOneComponent_div_6_Template(rf, ctx) {
    ...
    if (rf & 2) {
        const constructorStanding_r1 = ctx.$implicit;
...
let FormulaOneComponent = /*@__PURE__*/ (() => {
    class FormulaOneComponent {
        constructor(formulaOneService, sanitizer) {
        ...
        getConstructorStandings() {
            ...
            this.constructorStandingsSubscription = this.formulaOneService.getConstructorStandings().subscribe((data) => ((this.constructorStandings = data), console.log(this.constructorStandings)), (error) => console.error(error));
        }
    }
    FormulaOneComponent.ɵfac = function FormulaOneComponent_Factory(t) { return new (t || FormulaOneComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_shared_services_formula_one_formula_one_service__WEBPACK_IMPORTED_MODULE_1__["FormulaOneService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["DomSanitizer"])); };
    FormulaOneComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FormulaOneComponent, selectors: [["ng-component"]], decls: 7, vars: 1, consts: [[1, "row"], [1, "col-lg-5"], [1, "mb-0", "py-3", "bg-white", "text-center", "header-teams"], [1, "card", 2, "background", "#171717"], [1, "card-body"], ["class", "d-flex flex-row pb-2 team", 4, "ngFor", "ngForOf"], [1, "d-flex", "flex-row", "pb-2", "team"], [1, "team-position", "mr-3"], [1, "align-self-center"], ["width", "40", 3, "src"], [1, "ml-3", "pr-3", "align-items-center", "d-flex", "justify-content-between", "team-name", 2, "width", "100%", "color", "white"], [1, "team-name", "ml-3"], [1, "team-name"]], template: function FormulaOneComponent_Template(rf, ctx) {
            if (rf & 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormulaOneModule", function() { return FormulaOneModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
/* harmony import */ var _formula_one_routing__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./formula-one.routing */ "./src/app/routes/formula-one/formula-one.routing.ts");
...
/* harmony import */ var _formula_one_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./formula-one.component */ "./src/app/routes/formula-one/formula-one.component.ts");
...
let FormulaOneModule = /*@__PURE__*/ (() => {
    class FormulaOneModule {
    }
    FormulaOneModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: FormulaOneModule });
    FormulaOneModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function FormulaOneModule_Factory(t) { return new (t || FormulaOneModule)(); }, imports: [[
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(_formula_one_routing__WEBPACK_IMPORTED_MODULE_6__["FormulaOneRoutes"]),
                _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_8__["NgxDatatableModule"]
            ]] });
    return FormulaOneModule;
})();
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](FormulaOneModule, { declarations: [_formula_one_component__WEBPACK_IMPORTED_MODULE_9__["FormulaOneComponent"]], imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
            _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
            _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbModule"],
            ng2_charts__WEBPACK_IMPORTED_MODULE_4__["ChartsModule"],
            ng_chartist__WEBPACK_IMPORTED_MODULE_7__["ChartistModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_8__["NgxDatatableModule"]] });
})();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormulaOneRoutes", function() { return FormulaOneRoutes; });
/* harmony import */ var _formula_one_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./formula-one.component */ "./src/app/routes/formula-one/formula-one.component.ts");

const FormulaOneRoutes = [
    {
        path: '',
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConstructorInfoAdapter", function() { return ConstructorInfoAdapter; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


class ConstructorInfo {
}
let ConstructorInfoAdapter = /*@__PURE__*/ (() => {
    class ConstructorInfoAdapter {
        adapt(item) {
    ...
    ConstructorInfoAdapter.ɵfac = function ConstructorInfoAdapter_Factory(t) { return new (t || ConstructorInfoAdapter)(); };
    ConstructorInfoAdapter.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: ConstructorInfoAdapter, factory: ConstructorInfoAdapter.ɵfac, providedIn: 'root' });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConstructorStanding", function() { return ConstructorStanding; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConstructorStandingAdapter", function() { return ConstructorStandingAdapter; });
/* harmony import */ var _constructor_info_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constructor-info.model */ "./src/app/shared/models/formula-one/constructor-info.model.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _assets_data_formula_one_settings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../assets/data/formula-one-settings */ "./src/assets/data/formula-one-settings.ts");
...
let ConstructorStandingAdapter = /*@__PURE__*/ (() => {
    ...
    ConstructorStandingAdapter.ɵfac = function ConstructorStandingAdapter_Factory(t) { return new (t || ConstructorStandingAdapter)(); };
    ConstructorStandingAdapter.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: ConstructorStandingAdapter, factory: ConstructorStandingAdapter.ɵfac, providedIn: 'root' });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormulaOneService", function() { return FormulaOneService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var _core_data_service_formula_one_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../core/data-service/formula-one-api.service */ "./src/app/core/data-service/formula-one-api.service.ts");
/* harmony import */ var _models_formula_one_constructor_standing_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../models/formula-one/constructor-standing.model */ "./src/app/shared/models/formula-one/constructor-standing.model.ts");





let FormulaOneService = /*@__PURE__*/ (() => {
    class FormulaOneService {
        constructor(formulaOneApiService, constructorStandingAdapter) {
            this.formulaOneApiService = formulaOneApiService;
            this.constructorStandingAdapter = constructorStandingAdapter;
        }
        getConstructorStandings(year = 2022) {
            return this.formulaOneApiService
                .get(`constructors/standings/${year}`)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((data) => data.map((item) => this.constructorStandingAdapter.adapt(item))));
        }
    }
    FormulaOneService.ɵfac = function FormulaOneService_Factory(t) { return new (t || FormulaOneService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_core_data_service_formula_one_api_service__WEBPACK_IMPORTED_MODULE_2__["FormulaOneApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_models_formula_one_constructor_standing_model__WEBPACK_IMPORTED_MODULE_3__["ConstructorStandingAdapter"])); };
    FormulaOneService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: FormulaOneService, factory: FormulaOneService.ɵfac, providedIn: 'root' });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formulaOneSettings", function() { return formulaOneSettings; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSettings", function() { return getSettings; });
const formulaOneSettings = [
    {
        season: 2022,
        constructors: [
            {
